...
class Sale extends Admin_Controller {
    ...
    public function index() {
        ...
        if(isset($_POST['save'])) {
            ...
            $content = "Thanks for purchasing, you have purchase " . $productStr . " and paid " . $this->input->post("paid") . " Tk in " . $this->input->post("method") . " and your current balance is " . $this->input->post("current_balance") . " Tk " . $sign . "Regards, NIHAL TELECOM.";
    ...
    public function itemWise() {
        ...
        $select   = ['sapitems.sap_at', 'sapitems.voucher_no', 'sapitems.product_serial', 'sapitems.product_model', 'sapitems.quantity', 'sapitems.unit', 'sapitems.sap_type', 'godowns.name as godown_name'];
