...
class viewDealerSaleReturn extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if(empty($voucherInfo)){
            redirect('sale/all_sale_return', 'refresh');
        }
        ...
        if($voucherInfo->sap_type == 'cash'){
            ...
            $previousBalanceInfo = (object)get_client_balance($voucherInfo->party_code, get_name('partytransaction', 'id', ['relation' => 'sale_return:'. $voucherInfo->voucher_no]));
        ...
        $this->load->view('components/sale/view-dealer-sale-return', $this->data);
