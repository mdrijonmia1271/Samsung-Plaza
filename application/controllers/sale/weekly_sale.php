...
*
**/
class Weekly_sale extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->data['subMenu']      = 'data-target="weekly"';
        ...
        $this->load->view('components/sale/weekly_sale', $this->data);
    ...
    private function create() {
        ...
        $date = date('Y-m-d', strtotime($_POST['date'] . "+7 days"));
    ...
    private function sendSMS(){
        ...
        if(isset($_POST['send_sms'])){
            ...
            //$content = "Dear ".filter($customer_name->name). ", Bill No: ".$this->data['voucher_no']. ", Bill Amt: " . $this->input->post("hire_price") . " Tk, " . ", Paid Amt: ". $this->input->post('paid')." Tk, Cur Due: ".$this->input->post("current_balance")." Tk, Total Due: " . $this->input->post("grand_total") . " Tk,  Date: ".$this->input->post('date')." NIHAL TELECOM.";
            $content = "নামঃ ".filter($customer_name->name). ", বিল নংঃ ".$this->data['voucher_no']. ", বিল এমাউন্টঃ " . $this->input->post("hire_price") . " Tk, " . ", জমাঃ  ". $this->input->post('paid')." Tk, অবশিষ্ট বাকীঃ ".$this->input->post("current_balance")." Tk, মোট বাকীঃ " . $this->input->post("grand_total") . " Tk,  তাংঃ ".$this->input->post('date')." Sharif Iqbal Electronics.";
