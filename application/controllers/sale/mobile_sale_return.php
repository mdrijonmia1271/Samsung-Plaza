...
class Mobile_sale_return extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['subMenu']      = 'data-target="mobile_sale_return"';
        ...
        $this->load->view('components/sale/mobile_sale_return', $this->data);
    ...
    public function store()
    {
        if (isset($_POST['save'])) {
            ...
            $msg = [
                'title' => 'success',
                'emit'  => 'Sale return successfully completed.',
                'btn'   => true
            ];

            if ($_POST['sap_type'] == 'cash') {
                $redirect = 'sale/mobile_sale_return/invoice?vno=' . $vno;
            } else {
                $redirect = 'sale/mobile_sale_return?vno=' . $vno;
            }

            $this->session->set_flashdata('confirmation', message('success', $msg));
            redirect($redirect, 'refresh');
        } else {
            redirect('sale/mobile_sale_return', 'refresh');
        }
    }
    ...
    public function delete($vno = null)
    {
        ...
        if (!empty($saleInfo)) {
            ...
            save_data('partytransaction', $data, ["relation" => "sale_return:" . $vno]);

            $msg = [
                'title' => 'delete',
                'emit'  => 'Sale return delete successful.',
                'btn'   => true
            ];
