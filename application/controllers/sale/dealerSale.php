    ...
    public function index() {
        ...
        if(isset($_POST['save'])) {
            ...
            if(isset($_POST['send_sms'])){
                ...
                $content            = "নামঃ ".filter($customer_name->name). ", বিল নংঃ ".$this->data['voucher_no']. ", বিল এমাউন্টঃ " . $this->input->post("grand_total") . " Tk, " . ", জমাঃ ". $this->input->post('paid')." Tk, অবশিষ্ট বাকীঃ ".abs($current_due)." Tk, মোট বাকীঃ " . $this->input->post("current_balance") . " Tk,  তাংঃ ".$this->input->post('date')." Sharif Iqbal Store.";
        ...
        $this->load->view('components/sal/dealer-sale', $this->data);
