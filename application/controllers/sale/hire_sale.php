...
class Hire_sale extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->data['subMenu']      = 'data-target="hire_sale"';
    ...
    private function handelStock($index) {
        ...
        // set the quantity
        if(!empty($_POST['product_serial'][$index])){
    ...
    private function sendSMS(){
        ...
        if(isset($_POST['send_sms'])){
            ...
            $content = "নামঃ ".filter($customer_name->name). ", বিল নংঃ ".$this->data['voucher_no']. ", বিল এমাউন্টঃ " . $this->input->post("hire_price") . " Tk, " . ", জমাঃ  ". $this->input->post('paid')." Tk, অবশিষ্ট বাকীঃ ".$this->input->post("current_balance")." Tk, মোট বাকীঃ " . $this->input->post("grand_total") . " Tk,  তাংঃ ".$this->input->post('date')." Sharif Iqbal Store.";
