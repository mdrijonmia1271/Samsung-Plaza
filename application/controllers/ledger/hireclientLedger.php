<?php
class HireclientLedger extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->data['subMenu']      = 'data-target="'.'hireclient'.'-ledger"';
        ...
        $this->load->view('components/ledger/hireclient-ledger', $this->data);
