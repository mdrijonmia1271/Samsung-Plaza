...
class Weekly_sale extends Admin_Controller {
    ...
    private function sendSMS(){
        ...
        if(isset($_POST['send_sms'])){
            ...
            //$content = "Dear ".filter($customer_name->name). ", Bill No: ".$this->data['voucher_no']. ", Bill Amt: " . $this->input->post("hire_price") . " Tk, " . ", Paid Amt: ". $this->input->post('paid')." Tk, Cur Due: ".$this->input->post("current_balance")." Tk, Total Due: " . $this->input->post("grand_total") . " Tk,  Date: ".$this->input->post('date')." Rafiq Electronics.";
