...
class DealerSaleEditCtrl extends Admin_Controller {
    ...
    public function index() {
        ...
        if(isset($_POST['change'])) {
           ...
           /* $sign = ($this->input->post("current_sign") == 'Receivable') ? 'Payable' : 'Receivable';
            ...
            redirect("sale_elec/dealerSaleEditCtrl?vno=". $_POST['voucher_no'], 'refresh');
        }
        ...
        $this->load->view('components/sale_elec/edit-dealer-sale', $this->data);
    ...
    private function change(){
        ...
        $due = $this->input->post('grand_total') - $this->input->post('total_paid');
