      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <div class="row">
	            ...
	            <?php if(ck_action("dashboard","client_collection")){ ?>
	            <div class="col-md-3">
	            ...
	            <div class="col-md-3">
	               <div class="dash-box dash-box-6">
	                  <span>Today's Showroom Rcv</span>
	                  <h1><?php echo !empty($mdTransactionReceived) ? $mdTransactionReceived : 0; ?></h1>
	               </div>
	            </div>
	            ...
	            <div class="col-md-3">
	               <div class="dash-box dash-box-9">
	                  <span>Today's Showroom Paid</span>
	                  <h1><?php echo !empty($mdTransactionPaid) ? $mdTransactionPaid : 0; ?></h1>
	               </div>
	            </div>
