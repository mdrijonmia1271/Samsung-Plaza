...
<script src="<?php echo site_url('private/js/ngscript/allHireDueCtrl.js?'.$time); ?>"></script>
...
<div class="container-fluid" ng-controller="allHireDueCtrl" ng-cloak>
    <div class="row">
        <div id="loading">
        ...
        <div class="panel panel-default loader-hide" id="data">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class="pull-left">View All Hire Due</h1>
            ...
            <div class="panel-body" ng-cloak>
                ...
                <div class="row none">
                    ...
                    <?php } else { ?>
                    <input type="hidden" name="godown_code" ng-init="godown_code = '<?php echo $this->data['branch']; ?>'" ng-model="godown_code" required>
                    <?php } ?>
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th width="35%" class="print-width">Customer Name</th>
                        <th>Address</th>
                        <th>Mobile</th>
                        <th>Balance</th>
