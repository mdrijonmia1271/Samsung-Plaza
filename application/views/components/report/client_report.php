        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class="pull-left"> Client Wise Sales Report </h1>
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered">
                    ...
                    $total_current_month_sale =   $total_last_month_sale = 0;    
                     ...
                     <?php  
                                    ...
                                    if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_from']) && ($_POST['month_from'] != ''))){
                                        if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_from']) && ($_POST['month_from'] != ''))){
                                            ...
                                            // last month sale 
                                            $last_month_sale = get_sum('saprecords','total_bill',array('sap_at >=' => $start,'sap_at <=' => $end,'trash' => 0,'status' => 'sale','party_code' => $row->party_code));
                                        ...
                                        if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_to']) && ($_POST['month_to'] != ''))){
                                            ...
                                            $current_month_sale = get_sum('saprecords','total_bill',array('sap_at >=' => $start,'sap_at <=' => $end,'trash' => 0,'status' => 'sale','party_code' => $row->party_code));
                                        }
                                    }else{
                        ...
                        //if(($last_month_sale >0) || ($current_month_sale >0)){            
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $last_month_sale;$total_last_month_sale += $last_month_sale; ?> </td>
                                        <td><?php echo $current_month_sale; $total_current_month_sale += $current_month_sale; ?></td>
                                        <td>
                                            <?php if($current_month_sale >$last_month_sale){ ?>
                    ...
                    <tr>
                        ...
                        <td><strong><?php  echo number_format($total_last_month_sale,2); ?>TK</strong> </td>
                        <td><strong><?php  echo number_format($total_current_month_sale,2); ?> TK</strong> </td>
                        <td></td>
                    </tr>
                </table>
            </div>
