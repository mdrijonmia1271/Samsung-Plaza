<script src="<?php echo site_url('private/js/ngscript/sales_elec/ngscript/EditPurchaseEntry.js?') . time(); ?>"></script>
<style>
    .table2 tr td {
        padding: 0 !important;
    }
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                echo form_open('purchase_elec/editPurchase?vno=' . $info->voucher_no, $attr);
                ?>
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td>
                            ...
                            <input type="number"  class="form-control" min="0"
                                   ng-model="item.purchase_commission_old" step="any" readonly>
                        </td>
                        <td>
