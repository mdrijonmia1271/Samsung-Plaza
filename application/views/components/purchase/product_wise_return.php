        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row new-row-1">
                    ...
                    <div class="col-md-2">
                        <select class="form-control" ng-model="select_godown_code" ng-change="getAllProductsFn()">
                    ...
                    <?php } else { ?>
                        <input type="hidden" ng-init="g_code = '<?php echo $this->data['branch']; ?>'"  ng-model="g_code" required>
                    <?php } ?>
                    ...
                    <div class="col-md-2">
                        <select name="party_code" ng-change="setPartyfn()" ng-model="partyCode"  class="selectpicker form-control" data-show-subtext="true" data-live-search="true" required>
                            ...
                            <?php if(!empty($allParty)){ foreach($allParty as $key => $row){ ?>
                            <option value="<?php echo $row->code; ?>">
                                <?php echo filter($row->name)." ( ".$row->address." ) "; ?>
                            </option>
                            <?php }} ?>
