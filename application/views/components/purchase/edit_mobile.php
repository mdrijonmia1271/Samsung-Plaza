<script src="<?php echo site_url('private/js/ngscript/mobileEditPurchaseEntry.js?') . time(); ?>"></script>
<style>
    .table2 tr td {
        padding: 0 !important;
    }
...
<div class="container-fluid" ng-controller="mobileEditPurchaseEntry">
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                echo form_open('purchase/editMobile?vno=' . $info->voucher_no, $attr);
                ?>
                ...
                <!-- all hidden file -->
                <input type="hidden" ng-init="godown_code='<?php echo $info->godown_code; ?>'" ng-model="godown_code" ng-value="godown_code">
                <input type="hidden" name="voucher_no" ng-init="vno='<?php echo $info->voucher_no; ?>'" ng-model="vno" ng-value="vno">
                ...
                <table class="table table-bordered table2">
                    <tr>
                        ...
                        <th width="400px">IMEI NO</th>
                        <!--<th width="80px">Unit</th>-->
                        <th width="80px">S.Price</th>
                        <th width="80px">Comm.(%)</th>
                        <th class="th-width">Old Qty</th>
                        <th class="th-width">New Qty</th>
                        <th class="th-width">P.Price</th>
                    ...
                    <tr ng-repeat="item in records">
                        ...
                        <input type="hidden" name="godown_code[]" ng-value="item.godown">
                        ...
                        <td class="input" >
                            ...
                            g-blur="imeiExistenceCheck(item.imeiNO)"
                            ng-change="imeiExistenceCheck(item.imeiNO)"
                            ng-click="imeiExistenceCheck(item.imeiNO)"
                            ng-copy="imeiExistenceCheck(item.imeiNO)"
                            ng-cut="imeiExistenceCheck(item.imeiNO)"
                            ng-dblclick="imeiExistenceCheck(item.imeiNO)"
                            ng-focus="imeiExistenceCheck(item.imeiNO)"
                            ng-keydown="imeiExistenceCheck(item.imeiNO)"
                            ng-keypress="imeiExistenceCheck(item.imeiNO)"
                            ng-keyup="imeiExistenceCheck(item.imeiNO)"
                            ng-paste="imeiExistenceCheck(item.imeiNO)"
                            class="form-control" min="0"
                            ng-model="item.imeiNO" step="any" ng-required="true">
                        </td>
                        <!--<td class="input" ng-bind="item.unit"></td>-->
                        <td>
                        ...
                        <td>
                            <input type="number" name="purchase_commission[]" class="form-control" min="0"
                                   ng-model="item.purchase_commission" step="any" ng-readonly="true">
                        </td>
                        <td>
                            <input type="text" name="old_quantity[]" class="form-control" ng-model="item.old_quantity"
                                   readonly>
                        </td>
                        <td>
                            <input type="number" name="quantity[]" class="form-control"
                                   ng-model="item.quantity" ng-readonly="true">
                        </td>

                        <td>
                            <input type="text" name="purchase_price[]" class="form-control"
                                   ng-value="setPurchasePriceFn($index)">
                        </td>

                        <td>
                            <input type="text" name="old_subtotal[]" class="form-control" ng-model="item.old_subtotal"
                                   ng-value="getOldSubtotalFn($index)" readonly>
                        </td>
                        <td>
                    ...
                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="number" name="previous_balance"
                                               ng-value="partyInfo.previousBalance" class="form-control" step="any"
                                               readonly>
                                    </div>
                                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="number" ng-model="amount.paid" class="form-control"
                                               step="any">
                                    </div>
                                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="total_paid" ng-value="getTotalPaidFn()" class="form-control"
                                       step="any" readonly>
                            </div>
                        </div>
                        <div class="form-group">
