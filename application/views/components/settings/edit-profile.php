            ...
            <div class="panel-body">
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-xs-10">
                            <input type="text" name="username" value="<?php echo $profile[0]->username; ?>"
                    ...
                    <!--div class="form-group">
                        ...
                        <div class="col-md-7">
                            <select name="branch" class="form-control">
                                ...
                                <option <?php if($profile[0]->branch == "godown"){echo "selected";} ?> value="godown">Godown </option>
                                <?php foreach ($showroomInfo as $key => $row) { ?>
                                <option <?php if($profile[0]->branch == $row->showroom_id) {echo "selected";} ?> value="<?php echo $row->showroom_id; ?>"><?php echo $row->name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div-->
                    <?php 
                        $showroomInfo = getAllGodown();
                        if(checkAuth('super')){
                    ?>
                    <div class="form-group">
                        <label for="" class="col-md-3 control-label">Showroom</label>
                        <div class="col-md-7">
                            ...
                            <select name="branch" class="form-control">
                                ...
                                <option <?php echo ($profile[0]->branch==$row->code ? "selected": ''); ?> value="<?php echo $row->code; ?>"><?php echo $row->name; ?></option>
                                <?php } 
                                    } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-7">
                            <select name="privilege" class="form-control">
                                ...
                                <option value="admin" <?php if($profile[0]->privilege=='admin'){echo "selected"; } ?>>
                                    Admin</option>
                                <option value="user" <?php if($profile[0]->privilege=='user'){echo "selected"; } ?>>User
                                </option>
                            </select>
                        </div>
                    </div>
