            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12 text-center hide">
                        <h3 style="border: 1px solid #aaa; padding: 8px 10px; display: inline-block;">Item Wise
                            Purchase</h3>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="none">
                                    ...
                                    if ($val->sap_type == 'cash') {
                                        $viewBtn = 'sale/retail_sale/invoice?vno=' . $val->voucher_no;
                                    } else {
                                        $viewBtn = 'sale/viewDealerSale?vno=' . $val->voucher_no;
                                    }
                                    ?>
