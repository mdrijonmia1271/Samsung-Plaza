            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-4 print-font">
                        ...
                        <label>Customer ID : <?php echo $result[0]->party_code; ?></label><br>
                        </label> 
                    ...
                    <div class="col-xs-4 print-font">
                        ...
                        <label>Address : <?php echo $address; ?> </label>
                        <?php }else{ ?>
                            <label>Print Time : <?php echo $result[0]->sap_at; ?> - <?php echo date("h:i:s A"); ?></label>
                        <?php } ?>
                    </div>
                    <?php if($result[0]->sap_type == "cash" ) { ?>
                    <div class="col-xs-4 print-font">
                        <label>Print Time : <?php echo $result[0]->sap_at; ?> - <?php echo date("h:i:s A"); ?></label> <br>
                    </div>
                    <?php } ?>
                </div>
