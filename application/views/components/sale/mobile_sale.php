<script src="<?php echo site_url('private/js/ngscript/mobileSaleEntryCtrl.js?') . time(); ?>"></script>
<link rel="stylesheet"
...
<div class="container-fluid" ng-controller="mobileSaleEntryCtrl" ng-click>
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                echo form_open('sale/mobile_sale/store', $attr);
                ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        <select ui-select2="{ allowClear: true}" class="form-control" ng-model="productCodeElec"
                                data-placeholder="Select Product" ng-change="addNewProductFn()">
                            <option value="" selected></option>
                            <option ng-repeat="product in productListElec" value="{{product.code}}">
